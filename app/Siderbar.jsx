	...
	return (
		...
		<div className="flex flex-col items-center justify-normal gap-40 bg-secondary w-80 h-full pt-6 rounded-3xl">
			...
			<div className="flex flex-col justify-between h-72">
				<Link className={`flex font-medium rounded-md px-1 py-2 border-2 border-secondary w-52 ease-out duration-500 transition-all h-content cursor-pointer justify-between text-black text-2xl font-jacques ${activePage === 'Video Summary' ? 'bg-primary' : 'hover:bg-primary focus:bg-primary'}`}
                    onClick={() => setActivePage('Video Summary')}
					href={`/student/${params.studentid}`}>
					<p>Dashboard</p>
					<div className="p-2">
						<svg
							width="18"
				...
				<Link
					className={`flex font-medium rounded-md px-1 py-2 border-2 border-secondary w-52 ease-out duration-500 transition-all h-content cursor-pointer justify-between text-black text-2xl font-jacques ${activePage === 'Video Summary' ? 'bg-primary' : 'hover:bg-primary focus:bg-primary'}`}
                    onClick={() => setActivePage('Video Summary')}
